...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-8 pt-3 bg-white/90 backdrop-blur-xl border-t border-surface-container-high shadow-[0_-8px_32px_rgba(0,0,0,0.06)] md:hidden">
      {TABS.map((tab) => {
